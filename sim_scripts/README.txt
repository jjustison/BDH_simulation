...
* pop_sims.R - This script creates the lineage thru time simulation data while using different values of s. Data is stored in the 'pop_sims' and 'pop_sims_double_time' folders of 'data'


R packages required: SiPhyNetwork, R.utils, ape, fst, GillespieSSA
...
* plotting_ltt.R - Creates the ltt plots used in figures
